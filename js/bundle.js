...
;
/* harmony default export */ __webpack_exports__["default"] = (calc); // Ease slider
...
function cards() {
  var MenuItem = /*#__PURE__*/function () {
    function MenuItem(src, alt, title, descr, price, parent) {
    ...
    _createClass(MenuItem, [{
      ...
      value: function rendet() {
        ...
        element.innerHTML = "<img src=".concat(this.src, " alt=").concat(this.alt, ">\n            <h3 class=\"menu__item-subtitle\">").concat(this.title, "</h3>\n            <div class=\"menu__item-descr\">").concat(this.descr, "</div>\n            <div class=\"menu__item-divider\"></div>\n            <div class=\"menu__item-price\">\n                <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n                <div class=\"menu__item-total\"><span>").concat(this.parse, "</span> \u0433\u0440\u043D/\u0434\u0435\u043D\u044C</div>\n            </div>");
...
function forms(modaltimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (event) {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_11__["postData"])(' http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
      ...
      function showThanksModal(message) {
        ...
        Object(_modal__WEBPACK_IMPORTED_MODULE_10__["openModal"])('.modal', modaltimerId);
...
function openModal(modalSelector, modaltimerId) {
  var windowModal = document.querySelector(modalSelector);
...
function modal(triggerSelector, modalSelector, modaltimerId) {
  var openTrigger = document.querySelectorAll(triggerSelector);
  var windowModal = document.querySelector(modalSelector);
  ...
  windowModal.addEventListener('click', function (event) {
...
function tabs(tabsSelector, tabsContentSelector, tabsParantSelector, activeClass) {
  ...
  var tabsParant = document.querySelector(tabsContentSelector);
  var tabsContent = document.querySelectorAll(tabsParantSelector);
  ...
  hideTabContent();
  showTabsContent();
  tabsParant.addEventListener('click', function (event) {
...
window.addEventListener('DOMContentLoaded', function () {
  var modaltimerId = setInterval(function () {
